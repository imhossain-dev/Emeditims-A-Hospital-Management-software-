...
if(isset($_POST['submit'])){
  ...
  $conn = mysqli_connect("localhost","emeditim_username","password@000","emeditim_users");
     ...
     $uid = mysqli_real_escape_string($conn,$_POST['uid']);
      ...
      $sql = "SELECT * FROM doc_register WHERE contact = '$uid' and password = '$pwd'";
      ...
      exit();
         ...
         if($count == 1) {
            ...
            echo "<script>window.open('dashboard_doc.php','_self')</script>";
            exit();
         }else{
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="doc_login.php" method="post" class="form-box">
